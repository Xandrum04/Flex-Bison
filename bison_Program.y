...
%type <strvalue> PROGRAM STATEMENTS STATEMENT STATEMENT_IF STATEMENT_ELSE_IF STATEMENT_WHILE STATEMENT_BREAK STATEMENT_ASSIGN STATEMENT_SWITCH
...
STATEMENT_IF: TOKEN_IF TOKEN_LPAREN CONDITION TOKEN_RPAREN TOKEN_LBRACE STATEMENTS TOKEN_RBRACE { printf("IF Statement\n"); }
            | TOKEN_IF TOKEN_LPAREN CONDITION TOKEN_RPAREN TOKEN_LBRACE STATEMENTS TOKEN_RBRACE STATEMENT_ELSE_IF TOKEN_ELSE TOKEN_LBRACE STATEMENTS TOKEN_RBRACE { printf("IF ELSE Statement\n"); }
            ;

STATEMENT_ELSE_IF: TOKEN_ELSE_IF TOKEN_LPAREN CONDITION TOKEN_RPAREN TOKEN_LBRACE STATEMENTS TOKEN_RBRACE
                 | TOKEN_ELSE_IF TOKEN_LPAREN CONDITION TOKEN_RPAREN TOKEN_LBRACE STATEMENTS TOKEN_RBRACE STATEMENT_ELSE_IF
                 ;
